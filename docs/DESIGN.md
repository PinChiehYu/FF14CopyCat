...
實測（同一隊伍 Sugar Riot 滅團 vs 擊殺）：107 個錨點、時間差 -0.1～+0.3 秒。已知觀察：同一機制的隨機變化會使用不同技能 ID（例如 42641/42642），因此不會成為錨點。**尚未以兩個不同隊伍、轉場時間差異大的日誌驗證。**
...
- Viper：技能 ID 34606–34633 為 GCD、34634–34647 為 oGCD；職能技能與藥水為 oGCD。
